...
## 6.136.23 — 15 June 2026
- The "Reset all" confirmation on the Customise pages now reads "Reset Appearance settings?" / "Reset Behaviour settings?" instead of the garbled "Reset make it look the way you think?".
