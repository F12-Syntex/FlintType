...
## 6.136.6 — 15 June 2026
- In Burst mode, picking a different word list now re-rolls the words you see straight away, instead of only changing them after you restart the set.
