...
## 6.136.9 — 15 June 2026
- "Invite to a race" on a friend's profile now shows "Starting race…" while it sets up the lobby, and tells you to try again if it fails — instead of the menu just closing with nothing happening.
