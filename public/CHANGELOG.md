...
## 6.136.3 — 15 June 2026
- Fixed "peek the chrome back" while typing: with auto-hide set to fade (the default), moving your mouse to the very top or bottom edge of the screen now brings the top bar or footer back mid-run. Before, the faded bars never reappeared until the run ended.
