...
## 6.136.2 — 15 June 2026
- The "press ⌘+K to search" tip on the 404 page and in the command palette now shows "Ctrl" on Windows and Linux, instead of always showing the Mac ⌘ symbol.
