...
- Pressing space on an empty word no longer skips it, so you can't accidentally double-space past a word (and you can't "finish" a test by spamming space). Skipping a word's letters now correctly lowers your accuracy instead of still showing 100%.
