...
- Fixed the optional results heatmap so each letter is shaded by the time you actually spent on it. If you skipped, retyped, or mistyped a word mid-test, the colours no longer drift onto the wrong letters.
