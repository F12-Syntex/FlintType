...
## 6.136.15 — 15 June 2026
- Fixed the "Lines shown" setting's default: turning the "All" toggle off (or asking the AI for the default look) now restores 4 visible lines — the real default — instead of dropping you to 3.
