...
## 6.136.16 — 15 June 2026
- A high "minimum word length" no longer makes the passage loop the same handful of words: when too few words in the list are long enough, it now falls back to the full word list instead of repeating four words over and over.
