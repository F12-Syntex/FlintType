...
## 6.136.18 — 15 June 2026
- Visiting a profile link for a username that doesn't exist now shows a clear "no profile" message instead of a fake, all-zeros profile card for the made-up name.
