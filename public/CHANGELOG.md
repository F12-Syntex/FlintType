...
## 6.136.29 — 16 June 2026
- Signed-out visitors no longer fire pointless account-only requests on every page load, settings change, and finished test — removing the stream of errors in the browser console and the wasted network traffic. Your settings still save locally and sync up once you sign in.
