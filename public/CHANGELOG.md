...
## 6.136.27 — 16 June 2026
- Exporting your settings now includes your keypress-click (audio) and hand-layout preferences, so restoring a settings file on another browser or machine no longer silently drops them.
