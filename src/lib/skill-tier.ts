...
/** Note: the `levelForXp` / `xpForLevel` helpers that used to live
 *  here have been retired. The level economy now lives in
 *  `src/lib/level.ts` (10 completed tests = 1 level, matching the
 *  profile hero). Skill tiers remain a separate, WPM-based concept —
 *  a Grandmaster L3 player is faster than a Steady L20 player. */
