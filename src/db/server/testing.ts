...
const TRUNCATE_ALL = `
  TRUNCATE user_prefs, bigram_models, trigram_models, motor_feature_models, word_models, tests, notifications, users, follows, blocks, presence, live_sessions, live_spectators RESTART IDENTITY;
`;
