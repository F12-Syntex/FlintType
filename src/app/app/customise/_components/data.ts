...
export const SECTIONS: readonly Section[] = [
  // Appearance is a top-level entry rendered by the static
  // `/app/customise/appearance` route + its 11 sub-pages. The sidebar
  // expands it explicitly (see _components/sidebar.tsx); it doesn't
  // need a stub here.
  {
    id: "behaviour",
    name: "BEHAVIOUR",
